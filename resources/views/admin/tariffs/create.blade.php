...
@section('admin-title')<h1>tariffs — создать</h1>@endsection
@section('admin-content')
<form method="post" action="{ route('admin.tariffs.store') }" class="form-row">
@csrf
...
<div class="form-actions full">
  <a href="{ route('admin.tariffs.index') }" class="btn secondary">Отмена</a>
